...
(function ($) {
	...
	// User pool
	var poolData = {
		UserPoolId: 'ap-southeast-1_Rs3V47rQH', // Your user pool id here
		ClientId: '55d2hm6mvqki1mah0lr6hnh10t' // Your app client id here
	};

	// Your identity pool id here
	var identityPoolId = "ap-southeast-1:93160dcb-400e-4416-bb87-6678ac84c2a1"
	...
	function createCredentials(idToken) {
		AWS.config.credentials = new AWS.CognitoIdentityCredentials({
			...
			Logins: {
				'cognito-idp.ap-southeast-1.amazonaws.com/ap-southeast-1_Rs3V47rQH': idToken
			}
		});
